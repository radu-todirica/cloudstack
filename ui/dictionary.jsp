...
'label.disk.bytes.read.rate.max': '<fmt:message key="label.disk.bytes.read.rate.max" />',
'label.disk.bytes.read.rate.max.length': '<fmt:message key="label.disk.bytes.read.rate.max.length" />',
'label.disk.bytes.write.rate': '<fmt:message key="label.disk.bytes.write.rate" />',
'label.disk.bytes.write.rate.max': '<fmt:message key="label.disk.bytes.write.rate.max" />',
'label.disk.bytes.write.rate.max.length': '<fmt:message key="label.disk.bytes.write.rate.max.length" />',
'label.disk.iops.write.rate': '<fmt:message key="label.disk.iops.write.rate" />',
'label.disk.iops.write.rate.max': '<fmt:message key="label.disk.iops.write.rate.max" />',
'label.disk.iops.write.rate.max.length': '<fmt:message key="label.disk.iops.write.rate.max.length" />',
'label.disk.iops.read.rate': '<fmt:message key="label.disk.iops.read.rate" />',
'label.disk.iops.read.rate.max': '<fmt:message key="label.disk.iops.read.rate.max" />',
'label.disk.iops.read.rate.max.length': '<fmt:message key="label.disk.iops.read.rate.max.length" />',
