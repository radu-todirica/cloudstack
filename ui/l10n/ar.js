...
var dictionary = {
    ...
    "label.disk.bytes.read.rate.max":"Maximum Disk Read Rate (BPS)",
    "label.disk.bytes.read.rate.max.length":"Maximum Disk Read Rate (BPS) length",
    "label.disk.bytes.write.rate": "Disk Write Rate (BPS)",
    "label.disk.bytes.write.rate.max":"Maximum Disk Write Rate (BPS)",
    "label.disk.bytes.write.rate.max.length":"Maximum Disk Write Rate (BPS) length",
    "label.disk.iops.max": "Max IOPS",
    "label.disk.iops.min": "Min IOPS",
    "label.disk.iops.read.rate": "Disk Read Rate (IOPS)",
    "label.disk.iops.read.rate.max":"Maximum Disk Read Rate (IOPS)",
    "label.disk.iops.read.rate.max.length":"Maximum Disk Read Rate (IOPS) length",
    "label.disk.iops.total": "IOPS Total",
    "label.disk.iops.write.rate": "Disk Write Rate (IOPS)",
    "label.disk.iops.write.rate.max":"Maximum Disk Write Rate (IOPS)",
    "label.disk.iops.write.rate.max.length":"Maximum Disk Write Rate (IOPS) length",
